...
const ChildBlogRow = ({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -8 }}
      className="border-border relative pl-6"
    >
      <div className="bg-secondary/40 hover:bg-secondary border-border mb-2 flex items-center justify-between rounded-xl border p-4 pe-21 transition-all duration-200 hover:shadow-sm">
...
//   >
//     {/* Parent */}
//     <div className="group border-b-border-secondary bg-secondary-bg hover:border-b-primary/20 hover:bg-secondary relative grid min-h-16 grid-cols-[70px_2fr_1fr_1.5fr_140px_300px] items-center border-b px-5 py-3 shadow-sm transition-all duration-200 hover:shadow-md">
//       {/* ID */}
...
//           className="flex items-center gap-1 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-medium text-blue-700"
//         >
//           <Edit className="size-4" />
//           Edit
//         </Link>
...
//         <button
//           onClick={onDelete}
//           className="flex cursor-pointer items-center gap-1 rounded-lg border border-red-400 bg-red-500/10 px-3 py-2 text-sm font-medium text-red-500"
//         >
//           <Trash className="size-4" />
//           Delete
//         </button>

//         <button className="rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-medium text-blue-700">
//           More
//         </button>
//       </div>
